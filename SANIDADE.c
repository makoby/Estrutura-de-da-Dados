...
typedef struct no{
    ...
    struct no *ant; /* ponteiro para anterior nó */
}tNo;  /* tipo do nó */
...
int insereInicioLista(tLista *lista, int valor) {
    ...
    novoNo->dado = valor;
    novoNo->ant = NULL; /* lista cabeca aponta para novoNo*/
    novoNo->prox = lista->cabeca; /* O proximo de novoNo aponta para onde lista cabeca aponta*/
    lista->cabeca->ant = novoNo; /* O anterior do no para onde a lista cabeca apontava aponta para novoNo */
    //lista->cabeca = novoNo;
    lista->tamanho++;
    return 1;
}
...
int insereMeioLista(tLista *lista, int pos, int dado){
    ...
    novoNo->dado = valor;
    novoNo->prox = p->prox; /* O proximo de novoNo aponta para o proximo no imediatamente depois a posicao  na qual queremos inserir*/
    novoNo->ant = p;
    p->ant = novoNo; /* O anterior do no aponta o no para onde a lista cabeca apontava aponta para novoNo */
    p->prox = novoNo; /* lista cabeca aponta para novoNo*/
    lista->tamanho++;
